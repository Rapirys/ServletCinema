...
public class SortManager {
    ...
    public List<Film> findFilms(String search, String sort, String status, int page, int quantity, boolean desc) {
        ...
        if (status.equals("Any"))
            ...
            result = filmRepository.findAllByTitleEnContainsOrTitleRuContainsAndBoxOffice(search, search, false, pageable);
     ...
     */
    public HashMap<Film, List<List<Session>>> tableSessionByFilm(List<Film> films, String sort_session, LocalDate date1, LocalDate date2, boolean availability) {
