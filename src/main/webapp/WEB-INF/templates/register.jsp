            ...
            <form action="register" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-control"
                           placeholder=${lang.gL("User_Name")} placeholder="UserName">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" id="password" class="form-control"
                           placeholder="${lang.gL("Password")}">
                </div>
                <div class="form-group">
                    <label>${lang.gL("Confirm_Password")}</label>
                    <input type="password" class="form-control" id="confirm_password"
                           placeholder="${lang.gL("Confirm_Password")}" onkeyup='check();'>
...
<script type="text/javascript">(function () {
    window['__CF$cv$params'] = {
        r: '6d5a86e8c8761622',
        m: 'wxVC58W2Ck_KDJ3.M7X_TBEcFLBFrOBrIY3yqYgbcOM-1643543891-0-ATE8Sp5A6OcqsRbi7fme+bKto1+VgiY/ciB/rSJ6R3TISZWB2Q+V1bX/0J6uMaA/9verTEq4w0w25A8xGyhCU/thiVC8iz5XaegJvLrpu2D0OPl2fb01HjAluSmfneQtrcCPUCx9oqdofpDDjP94a0pe9VTajoRhLYHmtGEoWJEkh0XDUZvtW5uDtpKbAxSQz/6Hl/sdfbzInZ9tVX7JBuM=',
        s: [0x09b1881733, 0xdc94061b33],
    }
})();</script>
</body>
<script>
