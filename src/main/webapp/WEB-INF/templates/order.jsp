...
<form method="post" action="/cinema/order/pay">
        ...
        <div class="title">
            ...
            <c:choose>
                <c:when test="${title.equals('ru')}">
                    <label>${order.session.getFilm().getTitleRu()}</label>
                </c:when>

                <c:when test="${title.equals('en')}">
                    <label>${order.session.getFilm().getTitleEn()}</label>
                </c:when>
            </c:choose>
            <label>${order.session.getFilm().getFormatDuration()}</label>
            <p>
                ${order.session.date} ${order.session.time} ${order.session.price*(order.getTickets().size())}₴
            </p>
            <p>
        ...
        <div class="card-form">
            ...
            <div class="card-form__inner">
                ...
                <div class="card-input">
                    ...
                    <input type="text" name="cardName" id="cardName" class="card-input__input" v-model="cardName"
                ...
                <div class="card-form__row">
                    <div class="card-form__col">
                        <div class="card-form__group">
                            ...
                            <select name="dateM" class="card-input__input -select" id="cardMonth" v-model="cardMonth"
                                    v-on:focus="focusInput"
                            ...
                            <select name="dateY" class="card-input__input -select" id="cardYear" v-model="cardYear"
                                    v-on:focus="focusInput"
                                    v-on:blur="blurInput" data-ref="cardDate">
                    ...
                    <div class="card-form__col -cvv">
                        <div class="card-input">
                            ...
                            <input type="text" name="cvv" class="card-input__input" id="cardCvv" v-mask="'####'"
                                   maxlength="4" v-model="cardCvv"
